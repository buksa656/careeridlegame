...
const TASKS = [
    ...
    { name: "Raportowanie błędów do HelpDesku", unlocked: false, level: 0, baseIdle: 0.73, cycleTime: 2250, multiplier: 1, progress: 0, active: false, unlockCost: 1300, ascendLevel: 0 },
    { name: "Wklejka do Excela", unlocked: false, level: 0, baseIdle: 0.91, cycleTime: 3100, multiplier: 1, progress: 0, active: false, unlockCost: 2950, ascendLevel: 0 },
    { name: "Tworzenie Prezentacji do Statusu", unlocked: false, level: 0, baseIdle: 1.20, cycleTime: 3800, multiplier: 1, progress: 0, active: false, unlockCost: 5000, ascendLevel: 0 },
    ...
    { name: "Networking na LinkedInie", unlocked: false, level: 0, baseIdle: 6.2, cycleTime: 26000, multiplier: 1, progress: 0, active: false, unlockCost: 350000, ascendLevel: 0 },
    { name: "Król Open Space", unlocked: false, level: 0, baseIdle: 8.7, cycleTime: 43000, multiplier: 1, progress: 0, active: false, unlockCost: 650000, ascendLevel: 0 }
  ];
