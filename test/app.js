    ...
    "bonusDesc": "bonusDesc_coming_soon" }
            ...
            "translations": {
                ...
                "en": {
					...
					"help_content": "<h2>Help - Corporate Rat Guide</h2>\n<h3>[Game Goal]</h3>\n<p>Develop your career, earn <strong>Office Points (BP)</strong> and unlock tasks. Spend <strong>Soft Skills</strong> on upgrades.</p>\n<h3>[Controls]</h3>\n<ul>\n<li>Click buttons to unlock, upgrade, and promote tasks.</li>\n<li>Select <em>active tasks</em> (Focus) that generate BP.</li>\n</ul>\n<h3>[Energy]</h3>\n<ul>\n<li>Regenerates automatically: 1 energy every 10 minutes (max 100).</li>\n<li>Special skills cost energy: \nCoffee Break (25 energy): Doubles (<strong>x2</strong>) Office Points (BP) production from all tasks for <strong>15 minutes</strong>, \nFocus Mode (40 energy): +50% (<strong>x1.5</strong>) to BP production from all tasks for <strong>20 minutes</strong>, \nOvertime (60 energy): +1 additional Focus slot (you can have more active tasks) for <strong>30 minutes</strong>\n</li>\n<li>Watch ads to recover energy (max 5 daily, min 10 min between ads).</li>\n<li>Energy does not reset on prestige — incentivizing ad watching.</li>\n</ul>\n<h3>[Focus]</h3>\n<ul>\n<li>Only active tasks in Focus generate BP.</li>\n<li>Start with 4 slots, expandable with items (e.g., Organizer, Trophy).</li>\n<li>Switching Focus may cost BP, depending on settings.</li>\n</ul>\n<h3>[Tasks]</h3>\n<ul>\n<li>Discover new tasks, upgrade and promote them to maximize BP production.</li>\n<li>Bonuses from levels, promotions, desk items and skills increase efficiency.</li>\n</ul>\n<h3>[Soft Skills]</h3>\n<ul>\n<li>Earn Soft Skills through prestiging and completing challenges.</li>\n<li>Spend them to buy desk items with bonuses.</li>\n<li>Items boost BP production and provide additional Focus slots.</li>\n</ul>\n<h3>[Prestige]</h3>\n<ul>\n<li>Resets progress, keeps achievements and items.</li>\n<li>Rewards Soft Skills that have permanent impact.</li>\n<li>Unlocks access to advanced features and challenges.</li>\n</ul>\n<h3>[Tempo - Reward System]</h3>\n<ul>\n<li>Earn <strong>Tempo Tokens</strong> for active and efficient play.</li>\n<li>Ways to earn: efficient upgrades (5+ in 90s increasing BP/s by 20%), maintaining full Focus for 5 min, optimal promotions (+80% BP/s), important achievements, rapid Focus switches (4 in 30s).</li>\n<li>Buffs for tokens: Fast Forward (+25% speed for 120s), Flash Discount (-15% upgrade cost for 60s), Focus Snap (free switches +1 slot for 90s), Cashout Pulse (instant cycle completion).</li>\n<li>Each token = one buff. Use strategically at key moments!</li>\n<li>Tokens don't reset on prestige - they reward skill, not time.</li>\n</ul>\n<h3>[Tips]</h3>\n<ul>\n<li>Focus on tasks with the best BP generation.</li>\n<li>Upgrade mainly your active tasks.</li>\n<li>Expand Focus slots using desk items and skills.</li>\n<li>Use Tempo Tokens at strategic moments.</li>\n<li>Customize the game to your preferences in settings.</li>\n</ul>\n<p>Enjoy the game! 🍀</p>"
               }
            },
            "quotes": {
              "pl": [
